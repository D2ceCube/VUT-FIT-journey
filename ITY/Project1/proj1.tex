...
\usepackage[total={18cm,24.5cm}, top=2cm, left=1.5cm]{geometry}
...
\textsc{Tímto pravidlem se \underline{nikdy} nesmíte řídit.} Příliš časté zvýrazňování textových elementů a změny {\tiny velikosti} písma jsou známkou \textbf{amatérismu} autora a působí \texttt{velmi rušivě}. % kak blyat' sdelat' eto
...
V češtině se používají uvozovky typu \uv{9966} místo anglických \say{uvozovek}.
...
\footnotetext{Viz \href{http://petr.olsak.net/ftp/olsak/vlna/}{http://petr.olsak.net/ftp/olsak/vlna/}}
